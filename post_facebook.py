...
def make_facebook_post(dict_prices):
    ...
    # Add prices
    post_message += f"DIESEL: {gas_prices_message(dict_prices['CURRENT_WEEK']['GAS_KEY']['DIESEL'], dict_prices['PREVIOUS_WEEK']['GAS_KEY']['DIESEL'])}\n"
    post_message += f"GASOLINE 95: {gas_prices_message(dict_prices['CURRENT_WEEK']['GAS_KEY']['GASOLINE_95'], dict_prices['PREVIOUS_WEEK']['GAS_KEY']['GASOLINE_95'])}\n"
    post_message += f"GASOLINE 98: {gas_prices_message(dict_prices['CURRENT_WEEK']['GAS_KEY']['GASOLINE_98'], dict_prices['PREVIOUS_WEEK']['GAS_KEY']['GASOLINE_98'])}\n"
